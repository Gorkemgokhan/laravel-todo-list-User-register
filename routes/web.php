...
Route::get('/todo', [TaskController::class, 'todo'])->name('tasks.todo');

Route::get('/todo/view/{task}', [TaskController::class, 'todoshow'])->name('tasks.todo.view');

Route::get('/todo/{task}/view', [TaskController::class, 'todoedit'])->name('tasks.todo.edit');
